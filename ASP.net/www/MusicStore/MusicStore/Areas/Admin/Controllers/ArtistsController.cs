...
namespace MusicStore.Controllers
{
    ...
    public class ArtistsController : Controller
    {
        ...
        // GET: Artists
        public IActionResult Index(string letter = null)
        {
            var artist = _context.Artists.OrderBy(a => a.Name)
                    .ToList();
            // The name you give in asp-route-... must correspond to the method attribute.
            if (letter != null)
            {
                artist = artist
                    // Compare the first letter of the word to the incomming char.
                    .Where(a => a.Name.StartsWith(letter))
                    .ToList();
                return View(artist);
            }
